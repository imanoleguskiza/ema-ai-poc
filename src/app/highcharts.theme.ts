...
export async function applyBrandTheme() {
  ...
  const Highcharts = (mod as any).default ?? (mod as any);
  Highcharts.setOptions({
    colors: BRAND_COLORS,
    chart: { style: { fontFamily: 'inherit', color: BRAND_GREY_TEXT } },
    title: { style: { fontSize: '22px', fontWeight: '900', color: BRAND_GREY_TEXT } },
    subtitle: { style: { fontSize: '12px', fontWeight: '400', color: BRAND_GREY_TEXT } },
    legend: { itemStyle: { fontSize: '12px', fontWeight: '400', color: BRAND_GREY_TEXT } },
    tooltip: { style: { fontSize: '12px', fontWeight: '400', color: BRAND_WHITE_NEUTRAL } },
